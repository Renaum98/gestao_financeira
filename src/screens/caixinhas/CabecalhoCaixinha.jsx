...
export function CabecalhoCaixinha({ cx, atual, rendimento, rendimentoTotal = 0, comRendimento, pct }) {
  ...
  return (
    // O miolo claro é a própria cor com alpha CC — era o extremo claro do
    // gradiente antigo, e é contra ele que as CORES_CAIXINHA foram calibradas
    // pra dar contraste com o texto branco. Clarear mais quebraria a
    // calibragem; o resto do card só escurece, o que ajuda.
    <CardDestaque cor={cx.cor} corClara={`${cx.cor}CC`} style={{ padding: 22 }}>
      <>
