...
export const EN = {
  ...
  "1 cartão · fatura aberta": "1 card · open statement",
  "{n} cartões · faturas abertas": "{n} cards · open statements",
  ...
  " editou uma caixinha": " edited a savings jar",
  " excluiu uma caixinha": " deleted a savings jar",
  "Na caixinha \"{nome}\"": "In savings \"{nome}\"",
  // Push de atividade nas caixinhas (lib/atividade-caixinhas)
  "Seu parceiro": "Your partner",
  "{por} criou uma caixinha": "{por} created a savings jar",
  "{por} depositou {x}": "{por} deposited {x}",
  "{por} retirou {x}": "{por} withdrew {x}",
  "{por} editou uma caixinha": "{por} edited a savings jar",
  "{por} excluiu uma caixinha": "{por} deleted a savings jar",
